...
# Instruction code for swap instruction
intsig ISWAP 'I_SWAP'
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	  IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL, IIADDL, ILEAVE, ISWAP };
...
bool need_regids =
	f_icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL, IIADDL, ISWAP };

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, ICALL, IIADDL, ISWAP };
...
int d_srcA = [
	D_icode in { IRRMOVL, IRMMOVL, IOPL, IPUSHL, ISWAP  } : D_rA;
...
int d_srcB = [
	D_icode in { IOPL, IRMMOVL, IMRMOVL, IIADDL, ISWAP  } : D_rB;
...
int d_dstM = [
	D_icode in { IMRMOVL, IPOPL, ISWAP } : D_rA;
    D_icode in { ILEAVE } : REBP;
	1 : RNONE;  # Don't write any register
];
...
int aluA = [
	...
	E_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IIADDL, ISWAP } : E_valC;
...
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		     IPUSHL, IRET, IPOPL, IIADDL, ILEAVE, ISWAP } : E_valB;
...
bool F_stall =
	...
	E_icode in { IMRMOVL, IPOPL, ISWAP} &&
